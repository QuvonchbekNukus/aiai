...
class OpenAICompatibleScriptGenerator(ScriptGenerator):
    ...
    def _build_prompt(self, *, channel: ChannelConfig, topic: TopicRecord, prompt_template: str) -> str:
        return (
            f"{prompt_template}\n\n"
            "Write a 25-35 second script for a short vertical video.\n"
            "Use natural spoken English and tight pacing.\n"
            "Hook: under 14 words.\n"
            "Body: 3 short connected sentences.\n"
            "CTA: under 8 words.\n"
            "Avoid filler and obvious AI phrasing.\n\n"
