...
class OllamaScriptGenerator(ScriptGenerator):
    ...
    def _build_prompt(self, *, channel: ChannelConfig, topic: TopicRecord, prompt_template: str) -> str:
        return (
            ...
            "- Total spoken length should fit a 25-35 second short video.\n"
            "- Hook must be punchy and under 14 words.\n"
            "- Body must be 3 short sentences with smooth flow.\n"
            "- CTA must be under 8 words.\n"
            "- Avoid markdown, labels, bullet points, emojis, and filler.\n\n"
